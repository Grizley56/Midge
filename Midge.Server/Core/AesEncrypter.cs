...
namespace Midge.Server.Core
{
	class AesEncrypter: IEncrypter
	{
		...
		public static AesEncrypter Create()
		{
		...
		public static AesEncrypter Create(byte[] key, byte[] iv)
		{
			...
			return new AesEncrypter(algorithm);
		}

		private AesEncrypter(SymmetricAlgorithm alg)
		{
			_algorithm = alg;
